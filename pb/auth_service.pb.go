...
var file_auth_service_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x75, 0x73,
	0x65, 0x72, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x67, 0x63, 0x32, 0x70, 0x33,
...
var file_auth_service_proto_goTypes = []any{
	(*LoginServiceRequest)(nil),  // 0: auth.LoginServiceRequest
	(*LoginServiceResponse)(nil), // 1: auth.LoginServiceResponse
}
var file_auth_service_proto_depIdxs = []int32{
	0, // 0: auth.AuthService.Login:input_type -> auth.LoginServiceRequest
	1, // 1: auth.AuthService.Login:output_type -> auth.LoginServiceResponse
